...
public class ARCamera : MonoBehaviour
{
    ...
    public GameObject displayedGameObject;
		...
		if (marker == null) {
			...
			if (marker.Visible) {
				...
				if (Optical && opticalSetupOK) {
					pose = (opticalViewMatrix * marker.TransformationMatrix);
				} else {
	...
	protected virtual void ApplyTracking()
	{
		if (arVisible) {
            ...
            displayedGameObject.transform.localPosition = arPosition;
            displayedGameObject.transform.localRotation = arRotation;
		}
	}
